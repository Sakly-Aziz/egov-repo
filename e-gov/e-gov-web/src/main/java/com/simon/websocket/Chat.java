...
public class Chat {
    ...
    public void onOpen(Session session){
        ...
        Message message = new Message(Json.createObjectBuilder()
                .add("type", "text")
                .add("data", "*Notification* : A member has just Joinded us !!!")
    ...
    public void onClose(Session session){
        ...
        Message message = new Message(Json.createObjectBuilder()
                .add("type", "text")
                .add("data", "*Notification !!! *One Of The Members Has just Disconnected ")
                .build());
        ...
        System.out.println("*Notification* :one of the members has just disconnected");
    }    
}
